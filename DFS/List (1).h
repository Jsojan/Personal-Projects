...
// Note the List.h header file was largely based on the required function 
// definitions stated in the assignment 1 file which was used for the function
// definitions used in this header file.
